...
public class TranslateExtension : BindableObject, IMarkupExtension<BindingBase>
{
    ...
    public static readonly BindableProperty X0Property = BindableProperty.Create(nameof(X0), typeof(object), typeof(TranslateExtension), null,
            propertyChanged: (b, o, n) => ((TranslateExtension)b).OnTranslatedNameChanged());
    public object X0
    {
    ...
    public static readonly BindableProperty X1Property = BindableProperty.Create(nameof(X1), typeof(object), typeof(TranslateExtension), null,
            propertyChanged: (b, o, n) => ((TranslateExtension)b).OnTranslatedNameChanged());
    ...
    public string? TranslatedName
        => Name is string name && LocalizationResourceManager.Instance[name] is string translatedName
            ? string.Format(translatedName, X0, X1)
            : null;
